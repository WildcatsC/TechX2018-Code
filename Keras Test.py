...
def logReg(X,Y,bs,ep):
    ...
    model.add(Dense(1, activation='relu', input_shape=(1,),kernel_initializer='random_uniform',
                bias_initializer='random_uniform'))
...
#logReg(data, label, 20, 2)
plot_decision_boundary(data, label, logReg(data, label, 50, 1000))
